...
parser.add_argument("-emb_dim", dest="emb_dim", default=160, type=int, help="embedding dimension")
parser.add_argument("-emb_dim2", dest="emb_dim2", default=170, type=int, help="")
parser.add_argument("-emb_dim3", dest="emb_dim3", default=180, type=int, help="")
parser.add_argument("-emb_dim4", dest="emb_dim4", default=190, type=int, help="")
parser.add_argument("-emb_dim5", dest="emb_dim5", default=200, type=int, help="")
...
parser.add_argument('-RN', dest='RN',type=float, default=0)
