    ...
    def run(self):
        ...
        for ss_id in range(int(self.args.snapshot_num)):
            ...
            for test_ss_id in range(ss_id):
                ...
                print(self.kg.snapshots[ss_id].num_ent)
                res = self.test()
            ...
            ent, rel = self.model.get_combined_entity_embeddings()
        ...
        json_report_results['settings'] = {
                ...
                'num_ent_layers': args.num_ent_layers,
                'num_rel_layers': args.num_rel_layers
            }
        ...
        exp_id = args.dataset  + '-FastKGE-' + str(args.init) + '-' + str(args.rel_init) + '-' + str(args.learning_rate)  + '-' + str(args.epoch_num) +'-' + str(args.random_seed) + str(time.time()).split('.')[0] + '.json'
