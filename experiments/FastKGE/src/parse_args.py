...
# model setting
parser.add_argument("-model_name", dest="model_name", default="LoraKGE_Layers", help="name of model")
parser.add_argument("-batch_size", dest="batch_size", default=1024, help="Set the batch size")
parser.add_argument("-learning_rate", dest="learning_rate", default=1e-1, help="Set the learning rate")
...
parser.add_argument("-ent_r", dest="ent_r", default=150, help="The rank of ent lora")
parser.add_argument("-rel_r", dest="rel_r", default=20, help="The rank of rel lora")
...
parser.add_argument("-num_ent_layers", dest="num_ent_layers", default=2, help="The length of ent embeddings list")
parser.add_argument("-num_rel_layers", dest="num_rel_layers", default=1, help="The length of rel embeddings list")
parser.add_argument("-using_various_ranks", dest="using_various_ranks", default=True, help="Using various ranks or not")
...
parser.add_argument('-rel_init', dest='rel_init',type=int, default=0)
