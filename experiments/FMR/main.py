...
class experiment():
    ...
    def continual_learning(self):
        ...
        exp_id = args.dataset  + '-FMR-' + str(args.init) + '-' + str(args.learning_rate) + '-' + str(args.RN) + '-' + str(args.epoch_num) + '-' + str(args.seed) + str(time.time()).split('.')[0] + '.json'
